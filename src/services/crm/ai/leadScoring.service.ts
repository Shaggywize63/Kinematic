...
export interface Icp { industries?: string[]; company_sizes?: string[]; titles?: string[]; }
...
export function computeHeuristic(lead: Partial<Lead>, icp: Icp): { score: number; breakdown: ScoreBreakdown } {
  ...
  if (lead.source_id) breakdown.source = 10;
...
export async function rerankWithLlm(
  ...
  try {
    const userPayload = {
      ...
      heuristic_score: base.score, heuristic_breakdown: base.breakdown,
    ...
    const breakdown: ScoreBreakdown = {
      ...
      total: final, model: 'heuristic_v1+llm_rerank_v1',
    };
