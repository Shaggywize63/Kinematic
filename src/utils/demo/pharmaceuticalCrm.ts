 ...
 * resolve. Content is themed to an Eli Lilly Medical Representative's
...
const LEADS = [
  { id: 'demo-lead-1',  first_name: 'Dr. Anil',    last_name: 'Mehta',    company: 'Apollo Hospitals — Andheri',     email: 'dr.amehta@apollo.demo',       phone: '+91 98201 11111', status: 'qualified',   score: 92, score_grade: 'A', city: 'Mumbai',    industry: 'Pharmaceutical', specialty: 'Endocrinology',    product_interest: 'Mounjaro',  monthly_rx_potential: 240, source_id: 'demo-src-1', owner_id: 'demo-user-id', owner_name: MRS[0], last_activity_at: _now(-1),  created_at: _now(-14) },
  { id: 'demo-lead-2',  first_name: 'Dr. Kavita',  last_name: 'Iyer',     company: 'Manipal Hospital — Bengaluru',   email: 'dr.kiyer@manipal.demo',       phone: '+91 98202 22222', status: 'working',     score: 78, score_grade: 'A', city: 'Bengaluru', industry: 'Pharmaceutical', specialty: 'Oncology',         product_interest: 'Verzenio',  monthly_rx_potential: 120, source_id: 'demo-src-2', owner_id: 'demo-user-id', owner_name: MRS[1], last_activity_at: _now(-2),  created_at: _now(-21) },
  { id: 'demo-lead-3',  first_name: 'Dr. Suresh',  last_name: 'Kumar',    company: 'Ruby Hall Clinic — Pune',        email: 'dr.skumar@rubyhall.demo',     phone: '+91 98203 33333', status: 'new',         score: 64, score_grade: 'B', city: 'Pune',      industry: 'Pharmaceutical', specialty: 'Diabetology',      product_interest: 'Trulicity', monthly_rx_potential:  85, source_id: 'demo-src-3', owner_id: 'demo-user-id', owner_name: MRS[2], last_activity_at: _now(-4),  created_at: _now(-7)  },
  { id: 'demo-lead-4',  first_name: 'Dr. Neha',    last_name: 'Gupta',    company: 'AIG Hospitals — Hyderabad',      email: 'dr.ngupta@aighospitals.demo', phone: '+91 98204 44444', status: 'qualified',   score: 95, score_grade: 'A', city: 'Hyderabad', industry: 'Pharmaceutical', specialty: 'Endocrinology',    product_interest: 'Mounjaro',  monthly_rx_potential: 310, source_id: 'demo-src-4', owner_id: 'demo-user-id', owner_name: MRS[0], last_activity_at: _now(-1),  created_at: _now(-30) },
  { id: 'demo-lead-5',  first_name: 'Dr. Karthik', last_name: 'Pillai',   company: 'Apollo — Greams Road, Chennai',  email: 'dr.kpillai@apollo.demo',      phone: '+91 98205 55555', status: 'working',     score: 58, score_grade: 'B', city: 'Chennai',   industry: 'Pharmaceutical', specialty: 'Cardiology',       product_interest: 'Jardiance', monthly_rx_potential:  72, source_id: 'demo-src-5', owner_id: 'demo-user-id', owner_name: MRS[3], last_activity_at: _now(-5),  created_at: _now(-18) },
  { id: 'demo-lead-6',  first_name: 'Dr. Pooja',   last_name: 'Joshi',    company: 'SMS Hospital — Jaipur',          email: 'dr.pjoshi@smshospital.demo',  phone: '+91 98206 66666', status: 'unqualified', score: 22, score_grade: 'D', city: 'Jaipur',    industry: 'Pharmaceutical', specialty: 'General Medicine', product_interest: 'Humalog',   monthly_rx_potential:  18, source_id: 'demo-src-6', owner_id: 'demo-user-id', owner_name: MRS[4], last_activity_at: _now(-9),  created_at: _now(-35) },
  { id: 'demo-lead-7',  first_name: 'Dr. Manish',  last_name: 'Khanna',   company: 'Kokilaben — Andheri West',       email: 'dr.mkhanna@kokilaben.demo',   phone: '+91 98207 77777', status: 'qualified',   score: 84, score_grade: 'A', city: 'Mumbai',    industry: 'Pharmaceutical', specialty: 'Oncology',         product_interest: 'Verzenio',  monthly_rx_potential: 165, source_id: 'demo-src-2', owner_id: 'demo-user-id', owner_name: MRS[1], last_activity_at: _now(-3),  created_at: _now(-25) },
  { id: 'demo-lead-8',  first_name: 'Dr. Ishaan',  last_name: 'Bose',     company: 'AMRI Hospitals — Salt Lake',     email: 'dr.ibose@amri.demo',          phone: '+91 98208 88888', status: 'nurturing',   score: 48, score_grade: 'C', city: 'Kolkata',   industry: 'Pharmaceutical', specialty: 'Rheumatology',     product_interest: 'Olumiant',  monthly_rx_potential:  62, source_id: 'demo-src-3', owner_id: 'demo-user-id', owner_name: MRS[2], last_activity_at: _now(-12), created_at: _now(-42) },
  { id: 'demo-lead-9',  first_name: 'Dr. Tanvi',   last_name: 'Mehta',    company: 'Sterling Hospital — Ahmedabad',  email: 'dr.tmehta@sterling.demo',     phone: '+91 98209 99999', status: 'new',         score: 70, score_grade: 'B', city: 'Ahmedabad', industry: 'Pharmaceutical', specialty: 'Diabetology',      product_interest: 'Trulicity', monthly_rx_potential:  98, source_id: 'demo-src-1', owner_id: 'demo-user-id', owner_name: MRS[3], last_activity_at: _now(-1),  created_at: _now(-5)  },
  { id: 'demo-lead-10', first_name: 'Dr. Karan',   last_name: 'Verma',    company: 'BLK-Max — Delhi',                email: 'dr.kverma@blkmax.demo',       phone: '+91 98210 10101', status: 'working',     score: 88, score_grade: 'A', city: 'Delhi',     industry: 'Pharmaceutical', specialty: 'Neurology',        product_interest: 'Emgality',  monthly_rx_potential: 140, source_id: 'demo-src-7', owner_id: 'demo-user-id', owner_name: MRS[0], last_activity_at: _now(-2),  created_at: _now(-11) },
  { id: 'demo-lead-11', first_name: 'Dr. Aditya',  last_name: 'Nair',     company: 'Fortis — Bannerghatta',          email: 'dr.anair@fortis.demo',        phone: '+91 98211 12121', status: 'qualified',   score: 81, score_grade: 'A', city: 'Bengaluru', industry: 'Pharmaceutical', specialty: 'Endocrinology',    product_interest: 'Mounjaro',  monthly_rx_potential: 205, source_id: 'demo-src-5', owner_id: 'demo-user-id', owner_name: MRS[1], last_activity_at: _now(-1),  created_at: _now(-28) },
  { id: 'demo-lead-12', first_name: 'Dr. Diya',    last_name: 'Kapoor',   company: 'MIOT International — Chennai',   email: 'dr.dkapoor@miot.demo',        phone: '+91 98212 13131', status: 'new',         score: 38, score_grade: 'C', city: 'Chennai',   industry: 'Pharmaceutical', specialty: 'Oncology',         product_interest: 'Verzenio',  monthly_rx_potential:  55, source_id: 'demo-src-2', owner_id: 'demo-user-id', owner_name: MRS[2], last_activity_at: _now(-6),  created_at: _now(-9)  },
];
...
const ACCOUNTS = [
  ...
  { id: 'demo-acct-8', name: 'Kokilaben — Mumbai',             domain: 'kokilaben.demo',        industry: 'Hospital Network',    annual_revenue:  24000000000, owner_id: 'demo-user-id', owner_name: MRS[2], created_at: _now(-100) },
];
...
const CONTACTS = [
  ...
  { id: 'demo-ctc-7', first_name: 'Dr. Manish', last_name: 'Khanna',  email: 'dr.mkhanna@kokilaben.demo',   phone: '+91 98207 77777', title: 'Senior Oncologist',            account_id: 'demo-acct-8', account_name: 'Kokilaben — Mumbai',            owner_id: 'demo-user-id', owner_name: MRS[1] },
  { id: 'demo-ctc-8', first_name: 'Dr. R. K.',  last_name: 'Tandon',  email: 'rk.tandon@tmc.demo',          phone: '+91 98213 14141', title: 'Director — Oncology',          account_id: 'demo-acct-7', account_name: 'Tata Memorial Centre',          owner_id: 'demo-user-id', owner_name: MRS[1] },
];
...
const PIPELINES = [
  { id: 'demo-pipe',               name: 'Eli Lilly — HCP Engagement', is_default: true,  stages: HCP_STAGES },
...
const DEALS = [
  ...
  { id: 'demo-deal-6',  name: 'Dr. Manish Khanna — Verzenio adoption',       account_id: 'demo-acct-8', account_name: 'Kokilaben — Mumbai',             pipeline_id: 'demo-pipe', stage_id: 'demo-stg-5', stage_name: 'Adopted Prescriber', stage_type: 'open', status: 'open', amount: 1980000,  currency: 'INR', probability: 82,  win_probability_ai: 86,  owner_id: 'demo-user-id', owner_name: MRS[1], expected_close_date: _now(4).slice(0,10),  created_at: _now(-22) },
  { id: 'demo-deal-7',  name: 'Dr. Aditya Nair — Mounjaro switch',           account_id: 'demo-acct-3', account_name: 'Fortis Healthcare',              pipeline_id: 'demo-pipe', stage_id: 'demo-stg-2', stage_name: 'Detailing Visit',    stage_type: 'open', status: 'open', amount: 2460000,  currency: 'INR', probability: 25,  win_probability_ai: 38,  owner_id: 'demo-user-id', owner_name: MRS[2], expected_close_date: _now(22).slice(0,10), created_at: _now(-10) },
...
const DEMO_CUSTOM_FIELDS = [
  ...
  { id: 'demo-cf-2', entity: 'lead', key: 'product_interest',     label: 'Product Interest',     type: 'select', options: ['Mounjaro','Trulicity','Humalog','Verzenio','Olumiant','Emgality','Cyramza','Jardiance'],            required: true,  visible: true, position: 1 },
